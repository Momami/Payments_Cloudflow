...
class PaymentProcessingStreamlet extends FlinkStreamlet {
  ...
  class MyProcess extends CoProcessFunction[ParticipantInfo, PaymentObject, LogInfo] {
    ...
    override def processElement1(
      ...
      ctx: CoProcessFunction[ParticipantInfo, PaymentObject, LogInfo]#Context,
      out: Collector[LogInfo]
    ): Unit = participantState.put(value.participantId, value)
